globals  [ boardspace state th ti n o p q v]
patches-own [ pnumber background ]
turtles-own [ tnumber ]

to insanity1beginsrighthere
end
...
to go
  ask turtles with [shape = "blackscreen" or shape = "startleft" or shape = "startright"] [die wait .1]
  if th = 0 [reset-timer set th th + 1]
  if timer > Time-Between-Turns [gameover]
  if board-size = "4x4" and check > 63 [gameover]
  if board-size = "6x6" and check > 143 [gameover]
  if board-size = "8x8" and check > 253 [gameover]
  if count turtles with [shape = Play-To] > 0 [win]
...
to move4 [x y]
  if y = "up" [
    ask turtles with [ycor > 12] [ifelse [pnumber] of patch-ahead x = 2 or [pnumber] of patch-ahead x = tnumber [set pnumber 2 fd x set pnumber tnumber] [set pnumber tnumber] wait .0025]
    ask turtles with [ycor > 0] [ifelse [pnumber] of patch-ahead x = 2 or [pnumber] of patch-ahead x = tnumber [set pnumber 2 fd x set pnumber tnumber] [set pnumber tnumber] wait .0025]
    ask turtles with [ycor > -12] [ifelse [pnumber] of patch-ahead x = 2 or [pnumber] of patch-ahead x = tnumber [set pnumber 2 fd x set pnumber tnumber] [set pnumber tnumber] wait .0025]
    ask turtles with [ycor > -24] [ifelse [pnumber] of patch-ahead x = 2 or [pnumber] of patch-ahead x = tnumber [set pnumber 2 fd x set pnumber tnumber] [set pnumber tnumber] wait .0025]
  ]
  if y = "down" [
    ask turtles with [ycor < -12] [ifelse [pnumber] of patch-ahead x = 2 or [pnumber] of patch-ahead x = tnumber [set pnumber 2 fd x set pnumber tnumber] [set pnumber tnumber] wait .0025]
    ask turtles with [ycor < 0] [ifelse [pnumber] of patch-ahead x = 2 or [pnumber] of patch-ahead x = tnumber [set pnumber 2 fd x set pnumber tnumber] [set pnumber tnumber] wait .0025]
  ...
  if y = "right" [
    ask turtles with [xcor > 12] [ifelse [pnumber] of patch-ahead x = 2 or [pnumber] of patch-ahead x = tnumber [set pnumber 2 fd x set pnumber tnumber] [set pnumber tnumber] wait .0025]
    ask turtles with [xcor > 0] [ifelse [pnumber] of patch-ahead x = 2 or [pnumber] of patch-ahead x = tnumber [set pnumber 2 fd x set pnumber tnumber] [set pnumber tnumber] wait .0025]
    ask turtles with [xcor > -12] [ifelse [pnumber] of patch-ahead x = 2 or [pnumber] of patch-ahead x = tnumber [set pnumber 2 fd x set pnumber tnumber] [set pnumber tnumber] wait .0025]
    ask turtles with [xcor > -24] [ifelse [pnumber] of patch-ahead x = 2 or [pnumber] of patch-ahead x = tnumber [set pnumber 2 fd x set pnumber tnumber] [set pnumber tnumber] wait .0025]
  ]
  if y = "left" [
    ask turtles with [xcor < -12] [ifelse [pnumber] of patch-ahead x = 2 or [pnumber] of patch-ahead x = tnumber [set pnumber 2 fd x set pnumber tnumber] [set pnumber tnumber] wait .0025]
    ask turtles with [xcor < 0] [ifelse [pnumber] of patch-ahead x = 2 or [pnumber] of patch-ahead x = tnumber [set pnumber 2 fd x set pnumber tnumber] [set pnumber tnumber] wait .0025]
...
to move6 [x y]
  if y = "up" [
    ask turtles with [ycor > 16] [ifelse [pnumber] of patch-ahead x = 2 or [pnumber] of patch-ahead x = tnumber [set pnumber 2 fd x set pnumber tnumber] [set pnumber tnumber] wait .0025]
    ask turtles with [ycor > 8] [ifelse [pnumber] of patch-ahead x = 2 or [pnumber] of patch-ahead x = tnumber [set pnumber 2 fd x set pnumber tnumber] [set pnumber tnumber] wait .0025]
    ask turtles with [ycor > 0] [ifelse [pnumber] of patch-ahead x = 2 or [pnumber] of patch-ahead x = tnumber [set pnumber 2 fd x set pnumber tnumber] [set pnumber tnumber] wait .0025]
    ask turtles with [ycor > -8] [ifelse [pnumber] of patch-ahead x = 2 or [pnumber] of patch-ahead x = tnumber [set pnumber 2 fd x set pnumber tnumber] [set pnumber tnumber] wait .0025]
    ask turtles with [ycor > -16] [ifelse [pnumber] of patch-ahead x = 2 or [pnumber] of patch-ahead x = tnumber [set pnumber 2 fd x set pnumber tnumber] [set pnumber tnumber] wait .0025]
    ask turtles with [ycor > -24] [ifelse [pnumber] of patch-ahead x = 2 or [pnumber] of patch-ahead x = tnumber [set pnumber 2 fd x set pnumber tnumber] [set pnumber tnumber] wait .0025]
  ...
  if y = "right" [
    ask turtles with [xcor > 16] [ifelse [pnumber] of patch-ahead x = 2 or [pnumber] of patch-ahead x = tnumber [set pnumber 2 fd x set pnumber tnumber] [set pnumber tnumber] wait .0025]
    ask turtles with [xcor > 8] [ifelse [pnumber] of patch-ahead x = 2 or [pnumber] of patch-ahead x = tnumber [set pnumber 2 fd x set pnumber tnumber] [set pnumber tnumber] wait .0025]
    ask turtles with [xcor > 0] [ifelse [pnumber] of patch-ahead x = 2 or [pnumber] of patch-ahead x = tnumber [set pnumber 2 fd x set pnumber tnumber] [set pnumber tnumber] wait .0025]
    ask turtles with [xcor > -8] [ifelse [pnumber] of patch-ahead x = 2 or [pnumber] of patch-ahead x = tnumber [set pnumber 2 fd x set pnumber tnumber] [set pnumber tnumber] wait .0025]
    ask turtles with [xcor > -16] [ifelse [pnumber] of patch-ahead x = 2 or [pnumber] of patch-ahead x = tnumber [set pnumber 2 fd x set pnumber tnumber] [set pnumber tnumber] wait .0025]
    ask turtles with [xcor > -24] [ifelse [pnumber] of patch-ahead x = 2 or [pnumber] of patch-ahead x = tnumber [set pnumber 2 fd x set pnumber tnumber] [set pnumber tnumber] wait .0025]
...
to move8 [x y]
  if y = "up" [
    ask turtles with [ycor > 18] [ifelse [pnumber] of patch-ahead x = 2 or [pnumber] of patch-ahead x = tnumber [set pnumber 2 fd x set pnumber tnumber] [set pnumber tnumber] wait .0025]
    ask turtles with [ycor > 12] [ifelse [pnumber] of patch-ahead x = 2 or [pnumber] of patch-ahead x = tnumber [set pnumber 2 fd x set pnumber tnumber] [set pnumber tnumber] wait .0025]
    ask turtles with [ycor > 6] [ifelse [pnumber] of patch-ahead x = 2 or [pnumber] of patch-ahead x = tnumber [set pnumber 2 fd x set pnumber tnumber] [set pnumber tnumber] wait .0025]
    ask turtles with [ycor > 0] [ifelse [pnumber] of patch-ahead x = 2 or [pnumber] of patch-ahead x = tnumber [set pnumber 2 fd x set pnumber tnumber] [set pnumber tnumber] wait .0025]
    ask turtles with [ycor > -6] [ifelse [pnumber] of patch-ahead x = 2 or [pnumber] of patch-ahead x = tnumber [set pnumber 2 fd x set pnumber tnumber] [set pnumber tnumber] wait .0025]
    ask turtles with [ycor > -12] [ifelse [pnumber] of patch-ahead x = 2 or [pnumber] of patch-ahead x = tnumber [set pnumber 2 fd x set pnumber tnumber] [set pnumber tnumber] wait .0025]
    ask turtles with [ycor > -18] [ifelse [pnumber] of patch-ahead x = 2 or [pnumber] of patch-ahead x = tnumber [set pnumber 2 fd x set pnumber tnumber] [set pnumber tnumber] wait .0025]
  ...
  if y = "right" [
    ask turtles with [xcor > 18] [ifelse [pnumber] of patch-ahead x = 2 or [pnumber] of patch-ahead x = tnumber [set pnumber 2 fd x set pnumber tnumber] [set pnumber tnumber] wait .0025]
    ask turtles with [xcor > 12] [ifelse [pnumber] of patch-ahead x = 2 or [pnumber] of patch-ahead x = tnumber [set pnumber 2 fd x set pnumber tnumber] [set pnumber tnumber] wait .0025]
    ask turtles with [xcor > 6] [ifelse [pnumber] of patch-ahead x = 2 or [pnumber] of patch-ahead x = tnumber [set pnumber 2 fd x set pnumber tnumber] [set pnumber tnumber] wait .0025]
    ask turtles with [xcor > 0] [ifelse [pnumber] of patch-ahead x = 2 or [pnumber] of patch-ahead x = tnumber [set pnumber 2 fd x set pnumber tnumber] [set pnumber tnumber] wait .0025]
    ask turtles with [xcor > -6] [ifelse [pnumber] of patch-ahead x = 2 or [pnumber] of patch-ahead x = tnumber [set pnumber 2 fd x set pnumber tnumber] [set pnumber tnumber] wait .0025]
    ask turtles with [xcor > -12] [ifelse [pnumber] of patch-ahead x = 2 or [pnumber] of patch-ahead x = tnumber [set pnumber 2 fd x set pnumber tnumber] [set pnumber tnumber] wait .0025]
    ask turtles with [xcor > -18] [ifelse [pnumber] of patch-ahead x = 2 or [pnumber] of patch-ahead x = tnumber [set pnumber 2 fd x set pnumber tnumber] [set pnumber tnumber] wait .0025]
...
to-report check-up
  ...
  if board-size = "4x4" [
    ask turtles [if [pnumber] of patch-ahead 12 != tnumber or [pnumber] of patch-ahead 12 != 2  [set n n + 1 ]]
    report n]
  if board-size = "6x6" [
    ask turtles [if [pnumber] of patch-ahead 8 = tnumber or [pnumber] of patch-ahead 8 = 2  [set n n + 1]]
    report n]
  if board-size = "8x8" [
    ask turtles [if [pnumber] of patch-ahead 6 != tnumber or [pnumber] of patch-ahead 6 != 2  [set n n + 1]]
    report n]
end
...
to-report check-right
  ...
  if board-size = "4x4" [
    ask turtles [if [pnumber] of patch-ahead 12 != tnumber or [pnumber] of patch-ahead 12 != 2  [set o o + 1]]
    report o]
 if board-size = "6x6" [
    ask turtles [if [pnumber] of patch-ahead 8 = tnumber or [pnumber] of patch-ahead 8 = 2  [set o o + 1]]
    report o]
  if board-size = "8x8" [
    ask turtles [if [pnumber] of patch-ahead 6 != tnumber or [pnumber] of patch-ahead 6 != 2  [set o o + 1]]
    report o]
end
...
to-report check-down
  ...
  ask turtles [facexy xcor ycor - 100]
  if board-size = "4x4" [
    ask turtles [if [pnumber] of patch-ahead 12 != tnumber or [pnumber] of patch-ahead 12 != 2  [set p p + 1]]
    report p]
  if board-size = "6x6" [
    ask turtles [if [pnumber] of patch-ahead 8 = tnumber or [pnumber] of patch-ahead 8 = 2  [set p p + 1]]
    report p]
  if board-size = "8x8" [
    ask turtles [if [pnumber] of patch-ahead 6 != tnumber or [pnumber] of patch-ahead 6 != 2  [set p p + 1]]
    report p]
end
...
to-report check-left
  ...
  ask turtles [facexy xcor - 100 ycor]
  if board-size = "4x4" [
    ask turtles [if [pnumber] of patch-ahead 12 != tnumber or [pnumber] of patch-ahead 12 != 2  [set q q + 1]]
    report q]
  if board-size = "6x6" [
    ask turtles [if [pnumber] of patch-ahead 8 = tnumber or [pnumber] of patch-ahead 8 = 2  [set q q + 1]]
    report q]
  if board-size = "8x8" [
    ask turtles [if [pnumber] of patch-ahead 6 != tnumber or [pnumber] of patch-ahead 6 != 2  [set q q + 1]]
    report q]
end

to insanity1endsrighthere
end
@#$#@#$#@
GRAPHICS-WINDOW
430
